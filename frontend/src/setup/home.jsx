          ...
          <div className="mx-auto max-w-7xl lg:grid lg:grid-cols-12 lg:gap-x-8 lg:px-8">
            <div className="flex flex-col justify-center px-4 py-12 md:py-16 lg:col-span-7 lg:gap-x-6 lg:px-6 lg:py-24 xl:col-span-6">
              ...
              <p className="mt-8 text-lg text-gray-700">
                We are looking for devs who are passionate about their work and
                are willing to put in the hard work to make a difference in the
                world. We are looking for individuals who are committed to
                making a positive impact in their communities and the world at
                large.
              </p>
